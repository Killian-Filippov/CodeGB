export type JavaNodeLabel = 'Project' | 'Package' | 'File' | 'Class' | 'Interface' | 'Enum' | 'Annotation' | 'Method' | 'Constructor' | 'Field' | 'LocalVariable';
export type JavaRelType = 'CONTAINS' | 'EXTENDS' | 'IMPLEMENTS' | 'CALLS' | 'ACCESSES' | 'IMPORTS' | 'OVERRIDES' | 'TYPE_OF';
